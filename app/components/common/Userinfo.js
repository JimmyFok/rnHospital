    ...
    return (
      <LinearGradient
        ...
        <View style={styles.userMsg}>
          <Text style={styles.userName}>杜泽兵</Text>
          <TouchableOpacity
            style={styles.userChange}
            onPress={() => this.props.navigation.push('UserinfoLogout')}
          >
            <Text style={styles.userChangeText}>退出登录</Text>
          </TouchableOpacity>
          <Text style={styles.userId}>诊断卡号 : 1532465465465</Text>
        </View>
        <TouchableOpacity
